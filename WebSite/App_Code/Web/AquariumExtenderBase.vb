    ...
    Public Class AquariumExtenderBase
        ...
        Public Shared Sub RegisterFrameworkSettings(ByVal p As Page)
            If Not (p.ClientScript.IsStartupScriptRegistered(GetType(AquariumExtenderBase), "TargetFramework")) Then
                ...
                p.ClientScript.RegisterStartupScript(GetType(AquariumExtenderBase), "TouchUI", String.Format("var __settings={{appInfo:""TsCustomerPortal-master|{0}"",mobileDisplayDensity:""Auto"& _ 
                            """,desktopDisplayDensity:""Condensed"",mapApiIdentifier:""{1}"",labelsInList:""Display"& _ 
                            "edBelow"",initialListMode:""SeeAll"",buttonShapes:true,smartDates:true,sidebar:""Lan"& _ 
                            "dscape"",promoteActions:true,transitions:"""",theme:""Aquarium"",maxPivotRowCount: {2"& _ 
                            "},help:true,ui:""TouchUI""{3}}};", BusinessRules.JavaScriptString(HttpContext.Current.User.Identity.Name), ApplicationServices.MapsApiIdentifier, ApplicationServices.Create().MaxPivotRowCount, siteContent), true)
            End If
        End Sub
