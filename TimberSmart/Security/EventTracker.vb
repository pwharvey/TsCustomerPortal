...
Namespace Security
    ...
    Public Class EventTrackerBase
        ...
        Private Shared m_ModifiedByUserNameRegex As Regex = New Regex("ModifiedBy|updated_by", RegexOptions.IgnoreCase)
        
        Private Shared m_ModifiedByUserIdRegex As Regex = New Regex("ModifiedByUserId", RegexOptions.IgnoreCase)
        
        Private Shared m_ModifiedOnRegex As Regex = New Regex("ModifiedOn|updated|update_date", RegexOptions.IgnoreCase)
        
        Private Shared m_CreatedByUserNameRegex As Regex = New Regex("CreatedBy", RegexOptions.IgnoreCase)
        
        Private Shared m_CreatedByUserIdRegex As Regex = New Regex("CreatedById|created_user_id", RegexOptions.IgnoreCase)
        
        Private Shared m_CreatedOnRegex As Regex = New Regex("CreatedOn|create_date", RegexOptions.IgnoreCase)
