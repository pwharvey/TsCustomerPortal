    ...
    Public Class MembershipBarExtenderBase
        ...
        Protected Overrides Sub ConfigureScripts(ByVal scripts As List(Of ScriptReference))
            If EnableCombinedScript Then
                Return
            End If
            scripts.Add(New ScriptReference(CultureManager.ResolveEmbeddedResourceName("TimberSmart.daf-resources.js"), [GetType]().Assembly.FullName))
            scripts.Add(New ScriptReference("TimberSmart.daf-membership.js", [GetType]().Assembly.FullName))
        End Sub
    End Class
End Namespace
